...
Write-Host ""
Write-Host "If OpenClaw runs inside WSL2 instead of Windows PowerShell:"
Write-Host "  bash install_wsl.sh"
Write-Host "  python3 server.py --wsl-bridge"
Write-Host ""
...
Write-Host "  $PythonCommand $($Args -join ' ') --known-rules"
